...
import { BarChart, TrendingUp, Download, Calendar, DollarSign, Users, Building, PieChart } from "lucide-react";
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-2xl font-bold text-green-600">
                          ₹{(salesData.totalSales / 10000000).toFixed(1)}Cr
                        </p>
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-2xl font-bold text-blue-600">{salesData.unitsSOld}</p>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-2xl font-bold text-purple-600">
                          ₹{(salesData.avgDealSize / 100000).toFixed(1)}L
                        </p>
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-2xl font-bold text-yellow-600">{salesData.conversionRate}%</p>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      <thead className="bg-gray-50">
                        <tr>
                          <th className="text-left p-3 font-medium text-gray-900">Project Name</th>
                          <th className="text-left p-3 font-medium text-gray-900">Sales Revenue</th>
                          <th className="text-left p-3 font-medium text-gray-900">Units Sold</th>
                          <th className="text-left p-3 font-medium text-gray-900">Avg Price</th>
                        </tr>
                      </thead>
                      <tbody>
                        {salesData.topProjects.map((project, index) => (
                          <tr key={index} className="border-b hover:bg-gray-50">
                            ...
                            <td className="p-3 text-gray-600">₹{(project.sales / 100000).toFixed(1)}L</td>
                            <td className="p-3 text-gray-600">{project.units}</td>
                            <td className="p-3 text-gray-600">₹{(project.sales / project.units / 100000).toFixed(1)}L</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-2xl font-bold text-blue-600">{leadData.totalLeads}</p>
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-2xl font-bold text-green-600">{leadData.qualifiedLeads}</p>
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-2xl font-bold text-purple-600">{leadData.convertedLeads}</p>
